...
public class KfkProperties {
    ...
    public static Properties getProps(boolean isProducer, String appId) {
        ...
        properties.put(ConsumerConfig.CONNECTIONS_MAX_IDLE_MS_CONFIG, 10 * 60 * 1000 + 10);
        properties.put(ConsumerConfig.REQUEST_TIMEOUT_MS_CONFIG, 10 * 60 * 1000 + 9);
        properties.put(ConsumerConfig.SESSION_TIMEOUT_MS_CONFIG, 10 * 60 * 1000 + 8);
        properties.put(ConsumerConfig.HEARTBEAT_INTERVAL_MS_CONFIG, 10 * 60 * 1000 + 7);
